...
from .models import Post, Election, Candidate, CompleteBallot, BallotCast, ImagePost, CompleteBallot, Result
from .forms import *
...
def add_candidate(request):
    if request.method == 'POST':
        form = AddCandidateForm(request.user, request.POST, request.FILES)
        if form.is_valid():
